...
pagetitle: "Part 4: Creating Websites with Quarto"
...
<https://ohsu-octri-berd.github.io/Quarto_BERD_2025/>

<iframe width="1100" height="500" src="https://ohsu-octri-berd.github.io/Quarto_BERD_2025/" title="workshop website">
</iframe>
...
* [_quarto.yml](https://github.com/OHSU-OCTRI-BERD/Quarto_BERD_2025/blob/main/_quarto.yml){target="_blank"} excerpt:
...
* Exampl 1: See the [_quarto.yml](https://github.com/OHSU-OCTRI-BERD/Quarto_BERD_2025/blob/main/_quarto.yml){target="_blank"} excerpt in the Options tab
...
<iframe width="1100" height="500" src="https://ohsu-octri-berd.github.io/Quarto_BERD_2025/slides.html" title="workshop slides">
</iframe>
...
* Medium difficulty: 
    ...
    * Theme [`scss` files](https://github.com/quarto-dev/quarto-cli/tree/main/src/resources/formats/html/bootstrap/themes){target="_blank"} can be downloaded from GitHub
* Challenge: 
...
* The website theme is specified in [_quarto.yml](https://github.com/OHSU-OCTRI-BERD/Quarto_BERD_2025/blob/main/_quarto.yml){target="_blank"}
...
* Requires a [GitHub](https://github.com/){target="_blank"} account that is synced with your computer.
    - I *highly* recommend following __Jenny Bryan__'s *Happy Git and GitHub for the useR* [Pre-workshop set-up instructions](https://happygitwithr.com/workshops){target="_blank"} for getting your RStudio connected with GitHub.


---

* [Google doc](https://docs.google.com/document/d/1fXkRK7oT0U1lHaGpwD1j6r-3PdPYmokmPLuFk7QKKNk/edit?tab=t.0#heading=h.fpoewbfs170w) we created with **instructions to sync a Quarto website** to GitHub
