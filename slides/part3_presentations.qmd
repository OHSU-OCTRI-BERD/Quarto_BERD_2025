...
format: 
  revealjs:
      ...
      # fig-width: 9  # default: 9
      # fig-height: 5  # default: 5
  # html:
...
# set ggplot theme for slides 
    # Change the font size globally for all ggplots; keeps the default grey theme
# theme_update(text = element_text(size = 22))  
    # Change the theme to them_bw and change the font size
...
* Example of themes below are from <https://revealjs.com/themes/>.
    * The theme `.scss` files can be downloaded from [github](https://github.com/quarto-dev/quarto-cli/tree/main/src/resources/formats/revealjs/themes).
...
<!-- ![](../images/ggplot_default_theme_default_text_size.png){fig-align="center"} -->

### Customize individual figure
...
* The default figure size in revealjs slides is 9" x 5"
    * See [here](https://quarto.org/docs/computations/execution-options.html#figure-options) for default sizes for other output types.
...
* Navigate to a slide by pressing `g` and then typing the slide number or ID

### Hamburger menu

* Click on the hamburger menu at the bottom left (3 stacked horizontal lines) to see a table of contents of the slides. 
* Select the slide you want to navigate to

### Visual outline of slides
