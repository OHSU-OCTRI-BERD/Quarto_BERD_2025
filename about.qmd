...
The website structure was set up to be used as an example for demonstrating options when creating websites using Quarto in RStudio. See [Part 3 slides](slides/part3_webpages.qmd){target="_blank"} for more information.
